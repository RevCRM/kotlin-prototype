...
function renderSuggestion(suggestion: any, props: any) {
...
class IntegrationAutosuggest extends React.Component {
  ...
  handleSuggestionsFetchRequested = (fetch: any) => {
    this.setState({
      suggestions: getSuggestions(fetch.value),
    })
  }
    ...
    return (
      <div className={classes.root}>
        ...
        <Autosuggest
          ...
          renderSuggestionsContainer={options => (
            <Popper anchorEl={(this as any).popperNode} open={Boolean(options.children)}>
              <Paper
                square
                {...options.containerProps}
                style={{ width: (this as any).popperNode ? (this as any).popperNode.clientWidth : null }}
              >
                {options.children}
              </Paper>
            </Popper>
